...
NUM_TESTS = 5 # number of words to test when the user claims GOTIT
...
rule = r.random_rule(difficulty, top_level=True)
...
def test_user_GOTIT():
    ...
    print(("You will be asked to judge %s strings. Judge all of them correctly (as the rule would) "
        "and you win, but get any wrong and you lose.") % NUM_TESTS)
